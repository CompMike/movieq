...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { genre: @recommendation.genre, title: @recommendation.title, user_id: @recommendation.user_id }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { genre: @recommendation.genre, title: @recommendation.title, user_id: @recommendation.user_id }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
